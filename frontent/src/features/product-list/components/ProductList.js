...
import { decrement, increment, selectCount } from "../productlistSlice.js";
      ...
      <div>
        <div className="bg-white">
          <div>
            ...
            <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-0">
              ...
              >
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
                  ...
                  {/* Product grid */}
                  <div className="lg:col-span-3 overflow-scroll h-screen">
                    <div className="bg-white">
                      <div className="m">
                            ...
                            <Link to="/product-detail">
                              <div key={product.id} className="group relative">
                                <img
                                  ...
                                  className="aspect-square w-full rounded-md bg-gray-200 object-cover group-hover:opacity-75 lg:aspect-auto lg:h-80 overflow-scroll"
                                />
                                <div className="mt-4 flex justify-between ">
                                  <div>
                                    ...
                                    <p className="mt-1 text-sm text-gray-500 flex">
                                      <StarIcon className="h-5 w-6"></StarIcon>
